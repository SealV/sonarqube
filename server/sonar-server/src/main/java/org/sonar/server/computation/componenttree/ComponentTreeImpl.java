...
public class ComponentTreeImpl implements ComponentTree {
  ...
  private final List<ComponentTree> children;
  private final EventRepository eventRepository = new SetEventRepository();

  public ComponentTreeImpl(ComputationContext context, BatchReport.Component component, @Nullable Iterable<ComponentTree> children) {
    this.context = context;
    this.component = component;
    this.children = children == null ? Collections.<ComponentTree>emptyList() : copyOf(filter(children, notNull()));
  }

  @Override
  public BatchReport.Component getComponent() {
    return component;
  }
  ...
  public LanguageRepository getLanguageRepository() {
    return context.getLanguageRepository();
  }
